    ...
    return [
      {
        ...
        current: location.pathname.endsWith('/dashboard') || location.pathname.endsWith(`/${user?.entityId}`)
      },
      {
        name: 'Past Events',
        href: `${basePath}/events/past`,
        icon: Calendar,
        current: location.pathname.includes('/events/past')
      },
      {
        name: 'Upcoming Events',
        href: `${basePath}/events/upcoming`,
        icon: Calendar,
        current: location.pathname.includes('/events/upcoming')
      },
      {
        name: 'Achievements',
